...
class PlayerAdapterB(var context: Context, var topPlayerList:List<TopPlayer>): RecyclerView.Adapter<PlayerAdapterB.TopPlayerViewHolder>() {
    ...
    override fun onBindViewHolder(holderTopPlayer: TopPlayerViewHolder, position: Int) {
        ...
        var teamB_id= sharedPref.getString("teamB_id", null)

        holderTopPlayer.parent.setOnClickListener(){
            val intent = Intent(context, ShowActivity::class.java)
            intent.putExtra("team_Id", teamB_id)
